...
type
  ...
  TCodegenFunctionCall = class(TThing)
  strict private
    _FuncIndex: Integer;
  ...
  TCodegenIfStatement = class(TThing)
  strict private
  ...
  TCodegenReturnStatement = class(TThing)
  strict private
